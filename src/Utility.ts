...
/**
 * @name checkProfanity
 * @description Check if there are bad words in the text
...
export async function checkProfanity(text: string) : Promise<boolean> {
    ...
    let json = await axios("https://www.purgomalum.com/service/json?text="+encodeURI(text), {
        headers: {
    ...
    return json.result.includes("*") ? true : false
};
...
export async function getNPM(pkg : string = "npm") : Promise<any> {
    ...
    return {
        ...
        footer: { text: "Latest Version: "+pkga.version },
        fields: [
            {
                name: "License",
                value: pkga.license,
            ...
            {
                name: "Contributors",
                value: data.maintainers.map((m: any) => m = m.name).join(", ")
            },
            {
                name: "Source Code",
                value: `[Download](${pkga.dist.tarball}) [${pkga.dist.fileCount} file(s)]`
            }
        ]
    }
}
